...
/**
 * Fizz server configuration
 */
export interface FizzServerConfig {
...
/**
 * Fizz application configuration
 */
export interface FizzAppConfig {
...
/**
 * Complete Fizz configuration
 */
export interface FizzConfig {
  /** Default server name to use */
  default: string;
  /** Map of server configurations by name */
  servers: {
    [name: string]: FizzServerConfig;
  };
