...
import type { FizzConfig } from "../../src/config/types";
...
import type { IPubSubProvider } from "../../src/servers/fizz/contracts/pubsub-provider";
import { Factory } from "../../src/servers/fizz/factory";
...
// Mock the module
mock.module("../../src/servers/fizz/publishing/redis-pubsub-provider", () => {
  return {
